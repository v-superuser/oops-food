...
public class UploadService extends IntentService {
    ...
    private static final String ACTION_FOO = "com.vaibhav.foody.action.FOO";

    private Double previous_latitude;
    private Double previous_longitude;
    private static final String EXTRA_PARAM1 = "com.vaibhav.foody.extra.PARAM1";
    private static final String EXTRA_PARAM2 = "com.vaibhav.foody.extra.PARAM2";
